...
def main():
    ...
    query = {"question": 'Hi, my fuel filter is not working. Can you help me with that?'}
    
    #workflow = Graph()
    workflow = StateGraph(AgentState)
    workflow.add_node("Classifier", handler.function_1)
    workflow.add_node("Agent", handler.function_2)
    workflow.add_node("Router", handler.router)
